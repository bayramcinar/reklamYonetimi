...
const AdvertInfo = ({ handleButtonClick }) => {
  ...
  const baslangicTarihiErrorMessage =
    "Başlangıç tarihini ileriki tarihleden seçiniz.";
          ...
          <div className="flex-col lg:flex lg:flex-row flex-auto p-2 gap-x-10">
            ...
            <div className="flex-col flex-auto w-full lg:w-1/2 py-1">
              ...
              <p className="pb-3 lg:pb-4 text-txtGrey">
                Reklam adı müşteriye gönderilmeyecektir,kendi kontrolünüz için
        ...
        <div className="flex flex-col lg:flex-col flex-auto w-full lg:w-1/4">
          ...
          <div className="bg-grayBg p-3 border rounded-lg">
            ...
            <p className="text-txtGrey">
              ...
              harcanamayan günlük bütçe miktarı reklam bakiyenize iade edilir.
              Reklam bakiyenizde yeterli tutar olduğu takdirde reklam süresi
              boyunca hergün bu işlem tekrarlanır.
            </p>
          </div>
        </div>
        <div>
          ...
          <button type="submit" className="bg-red-300 border-red-600">
            Submit
          </button>
        </div>
      </div>
