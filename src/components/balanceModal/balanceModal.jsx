        ...
        <div className="relative px-5 bg-white rounded-2xl animate__animated animate__fadeInDown">
          ...
          <div className="flex flex-col max-w-[1200px] px-3  mx-auto rounded-lg bg-bgWhite">
              ...
              <div className="grid grid-cols lg:grid-cols-3  gap-y-5 gap-x-10 mb-10">
                <button className="border-2 border-borderGray p-2 rounded-lg bg-bgOrange  hover:border-b-premiumOrange  text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" onClick={() => handleAmount(100)}>
                  100₺
                </button>
                <button className="border-2 border-borderGray p-2 rounded-lg  hover:border-b-premiumOrange bg-bgOrange text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" onClick={() => handleAmount(250)}>
                  250₺
                </button>
                <button className="border-2 border-borderGray p-2 rounded-lg  hover:border-b-premiumOrange  bg-bgOrange text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" onClick={() => handleAmount(500)}>
                  500₺
                </button>
                <button className="border-2 border-borderGray p-2 rounded-lg   hover:border-b-premiumOrange  bg-bgOrange text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" onClick={() => handleAmount(750)}>
                  750₺
                </button>
                <button className="border-2 border-borderGray p-2 rounded-lg  hover:border-b-premiumOrange  bg-bgOrange text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" onClick={() => handleAmount(1000)}>
                  1000₺
                </button>
                <input type="number" placeholder="Farklı miktar gir" className="border-2 border-borderGray p-1 rounded-lg   hover:border-b-premiumOrange  bg-bgOrange text-center font-bold md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs ease-in duration-500" value={farkliMiktar} onChange={handleAmountChange} />
              </div>
              ...
              <div className="flex justify-between items-center py-10">
                <div className="flex justify-center items-center ps-2">
                  ...
                  />
                  <span className="p-2 items-start md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw]">
                ...
                <button
                  className="flex-col lg:flex items-center justify-center px-4 py-3 w-48 overflow-hidden md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs font-bold text-txtWhite bg-premiumOrange border border-5 border-premiumOrange rounded hover:bg-transparent hover:text-premiumOrange focus:outline-none focus:ring"
                  href="/satınal">
                  Satın Al
                </button>
              </div>
