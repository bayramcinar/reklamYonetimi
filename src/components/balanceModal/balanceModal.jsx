            ...
            <div className="flex flex-col max-w-[1200px] px-3  mx-auto rounded-lg bg-bgWhite">
              ...
              <div className="py-4 lg:py-10">
                <div className="tabs tab-group flex justify-start items-center relative">
                  <button className="tabs px-3 lg:px-10 relative md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs group transition-all duration-300 ease-in-out" onClick={()=>handleActivePage(1)}>
                  ...
                  <button className="tabs px-3 lg:px-10 relative md:text-[1.3vw] lg:text-[1.1vw] xl:text-[0.9vw] text-xs group transition-all duration-300 ease-in-out " onClick={()=>handleActivePage(2)}>
                  ...
                  <div className="vertical-line"></div>
                  <button className="tabs px-3 lg:px-10 relative group transition-all duration-300 ease-in-out text-xs" onClick={()=>handleActivePage(3)}>
                    <span className="bg-left-bottom bg-gradient-to-r  hover:text-premiumOrange from-premiumOrange to-txtRed bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out md:text-[1.3vw] lg:text-[1vw] xl:text-[1.1vw]">
                      Hesap Hareketleri
                    </span>
                  </button>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between  py-3 lg:py-10">
                ...
                <div className="flex  justify-center items-center flex-grow">
                  <button
                    className="flex items-center justify-center px-4 py-3 w-60 lg:w-48 overflow-hidden text-xs md:text-[1.1vw] lg:text-[1vw] xl:text-[0.9vw] font-bold text-txtWhite bg-premiumOrange border border-5 border-premiumOrange rounded hover:bg-transparent hover:text-premiumOrange focus:outline-none"
                    href="/satınal"
                  >
                    Satın Al
                  </button>
